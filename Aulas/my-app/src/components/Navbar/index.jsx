...
import { MyLink } from "../../Styles"; // Só estiliza o link pra não ficar com aquela cor azul
...
const Navbar = () => {
	...
	const alterarTema = () => {
		...
		/** Ternário:
		 * temaSelecionado === "claro" ? setTemaSelecionado("escuro") : setTemaSelecionado("claro");
